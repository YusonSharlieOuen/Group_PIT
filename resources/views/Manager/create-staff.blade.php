    ...
    <div class="py-10">
        <div class="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8">
            <div class="bg-white p-6 shadow-sm sm:rounded-lg">
                ...
                <form action="{{ route('manager.store') }}" method="POST" class="space-y-6">
                    @csrf
                    ...
                    <div class="grid grid-cols-1 gap-5 md:grid-cols-2">
                        ...
                        <div>
                            ...
                            <select id="position" name="position"
                                ...
                                <option value="Supervisor" @selected(old('position') === 'Supervisor')>
                                    Supervisor
                                </option>

                                <option value="Secretary" @selected(old('position') === 'Secretary')>
                                    Secretary
                                </option>

                                <option value="Staff" @selected(old('position') === 'Staff')>
                                    Staff
                                </option>
                            </select>
                        </div>
