    ...
    <x-slot name="header">
        <div class="flex items-center justify-between">
            ...
            <div class="flex gap-3">
                <a href="{{ route('manager.staff.index') }}" class="rounded-md border border-gray-300 px-4 py-2 text-sm font-semibold text-gray-700 hover:bg-gray-50">Back</a>
                <!-- <a href="{{ route('manager.staff.edit', $staff->staff_id) }}" class="rounded-md bg-gray-900 px-4 py-2 text-sm font-semibold text-white hover:bg-gray-700">Edit</a> -->
            </div>
        </div>
    </x-slot>
                    ...
                    @if ($staff->subordinates->count())
                        <ul class="mt-3 space-y-2 text-sm text-gray-700">
                            @foreach ($staff->subordinates as $subordinate)
                                <li>
                                    <a href="{{ route('manager.staff.show', $subordinate->staff_id) }}" class="hover:text-gray-950">
